...
translation_left_mat = pyrr.matrix44.create_from_translation(-obj.center - [obj.dia, 0, 0])
translation_mat = pyrr.matrix44.create_from_translation(-obj.center)
translation_right_mat = pyrr.matrix44.create_from_translation(-obj.center + [obj.dia, 0, 0])
